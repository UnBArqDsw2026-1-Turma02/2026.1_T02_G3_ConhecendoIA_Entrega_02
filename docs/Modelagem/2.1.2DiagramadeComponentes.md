# 2.1.2 Diagrama de Componentes :id=topo

## Introdução

O diagrama de componentes da UML (Unified Modeling Language) é um modelo estrutural utilizado para representar a organização e a dependência entre os componentes físicos de um sistema de software[<sup>1</sup>](#ref1). Um componente, nesse contexto, é definido como uma unidade modular com uma interface bem definida que encapsula sua implementação interna e pode ser facilmente substituída ou reutilizada. Esse tipo de diagrama é particularmente útil na modelagem de sistemas de médio a grande porte, pois permite visualizar a arquitetura de alto nível, evidenciando como os diferentes módulos — como bibliotecas, arquivos executáveis, APIs ou serviços — se comunicam entre si por meio de interfaces e dependências[<sup>1</sup>](#ref1). De acordo com a especificação oficial da UML, os diagramas de componentes são essenciais na fase de projeto e implantação, por fornecerem uma visão clara da estrutura física do sistema e das relações entre os artefatos de software[<sup>2</sup>](#ref2).

## Metodologia

A construção deste conteúdo baseou-se em uma abordagem qualitativa e bibliográfica, com o objetivo de apresentar, de forma clara e concisa, os principais conceitos relacionados ao diagrama de componentes da UML. Foram consultadas fontes especializadas e reconhecidas na área de engenharia de software, como o livro UML Distilled de Martin Fowler[<sup>1</sup>](#ref1) e a especificação oficial da UML publicada pela Object Management Group (OMG)[<sup>2</sup>](#ref2). A seguir, detalhamos os principais símbolos e representações utilizados neste tipo de diagrama. 
...
<img src="../assets/simboloComponente.png" alt="símbolo do Componente" width="250">
</center>
...
<img src="../assets/simboloPorta.png" alt="símbolo de Porta" width="250">
</center>
...
<img src="../assets/simboloDependencia.png" alt="símbolo de Dependencia" width="250">
</center>
...
<img src="../assets/simboloInterfaceFornecida.png" alt="símbolo de Interface Fornecida" width="250">
</center>
...
<img src="../assets/simboloInterfaceNecessaria.png" alt="símbolo de Interface Necessária" width="250">
</center>
...
<img src="../assets/simboloSubsistema.jpg" alt="símbolo de Subsistema" width="250">
</center>
...
<img src="../assets/diagrama_de_componentes.png" alt="Diagrama de Componentes" width="800">
...
`Interface Requerida:` (Usuarios) - Requer dados do usuário do subsistema Dados e serviços de autenticação.
### VisualizaDadosDeIA
 Permite aos usuários visualizar informações sobre inteligência artificial.

`Interfaces Requeridas:` (DadosDeIA) - Requer dados sobre IA do subsistema Dados.
### BuscaDeConteudo
 Facilita a busca por informações específicas sobre tópicos de IA.

`Interface Requerida:` (DadosDeIA) e (VisualizaDadosDeIA) - Requer dados do subsistema Dados.
### DestaqueDoDia
 Exibe a principal novidade ou ferramenta de IA do dia.

`Interface Requerida:` (DadosDeIA) e (BuscaDeConteudo) - Requer dados do destaque do dia do subsistema Dados.
### InterageNoForum: 
...
`Interface Fornecida:` (DadosDeIA) - Fornece dados .
`Interface Requerida:` (gerenciaDadosDeIA) - Requer os dados gerenciados no componente gerencia DadosDeIA.
...
`Interface Requerida:` (gerenciaDadosDeIA) - Requer o destaque presente no componente gerencia DadosDeIA.
...
`Interface Requerida:` (DadosDeIA) - Requer acesso e manipulação dos dados do subsistema Dados.
...
| 1.1    | 23/04/2026 | Correção dos componentes do diagrama de componentes  | [Vinícius Ribeiro](https://github.com/viniiribeiro) | [Ingrid Alves](https://github.com/alvesingrid)  |